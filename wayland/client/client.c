...
{
    /* Sent by the compositor when it's no longer using the buffer */
...
draw_frame(struct client_state *state)
{
    ...
    struct wl_buffer *buffer = wl_shm_pool_create_buffer(pool, 0, width, heigth, stride, WL_SHM_FORMAT_XRGB8888);
